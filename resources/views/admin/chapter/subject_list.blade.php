			...
			<div class="col-lg-12">
				...
				<div class="row mt-3">
					<div class="col-lg-12">
						...
						@endif
						<a href="{{ asset('admin/subject/add')}}"><button type="button" class="btn btn-success">Add Subject</button></a>
							   ...
							   @if(isset($chapterlist))
								    ...
								    @foreach($chapterlist as $list)
										<tr>
											...
											<td>@if(!empty($list->pdf))  <a target="_blank" href="{{ url('/public/uploads/pdf') }}/{{ $list->pdf }} }}" >PDF Link </a> @endif </td>
											<td>{{ $list->created_at }}</td>
											<td>
												<a href="{{ url('/admin/subject/edit') }}/{{ $list->id }}"><button type="button" class="btn btn-success">Edit</button></a>
