...
@section('content')
	...
	<div class="bg-white mt-4 mb-5">
		...
		@endif
		<form role="form" action="{{ asset('admin/add_loan_action') }}" method="POST" enctype='multipart/form-data'>
			@CSRF
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="tel" name="mobile_no" oninput="validatePhoneNumber(this);" maxlength="10" class="form-control @error('mobile_no') is-invalid @enderror" id="mobile_no" placeholder="MOBILE CARD" value="{{ old('mobile_no') }}" >
					@error('mobile_no')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="mobile">Mobile Number</label>
                    <input type="tel" name="coborrower_mobile_no" oninput="validatePhoneNumber(this);" maxlength="10" class="form-control @error('coborrower_mobile_no') is-invalid @enderror" id="coborrower_mobile_no" placeholder="MOBILE CARD" value="{{ old('coborrower_mobile_no') }}" >
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="mobile">Mobile Number</label>
                    <input type="tel" name="guarantor1_mobile_no" oninput="validatePhoneNumber(this);" maxlength="10" class="form-control @error('guarantor1_mobile_no') is-invalid @enderror" id="guarantor1_mobile_no" placeholder="MOBILE CARD" value="{{ old('guarantor1_mobile_no') }}" >
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="mobile">Mobile Number</label>
                    <input type="tel" name="guarantor2_mobile_no" oninput="validatePhoneNumber(this);" maxlength="10" class="form-control @error('guarantor2_mobile_no') is-invalid @enderror" id="guarantor2_mobile_no" placeholder="MOBILE CARD" value="{{ old('guarantor2_mobile_no') }}" >
