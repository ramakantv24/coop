						...
						<div class="box box-primary">
							...
							@endif
							 ...
							 <div class="tab-content" id="pills-tabContent p-3">								
							   <form role="form" action="{{ asset('admin/loan_import_action') }}" method="POST" enctype='multipart/form-data'>
								@CSRF
							   ...
							   @if(isset($loanfile))
								    ...
								    @foreach($loanfile as $list)
										<tr>
											...
											<td>
                                              <a href="{{ url('/admin/loan/import/delete') }}/{{ $list->id }}" onclick="return validateDelete(this);"><button type="button" class="btn btn-danger">Delete</button></a>
											  @if($list->status=='0')
                                              	<a href="{{ url('/admin/loan/import/update-status') }}/{{ $list->id }}" ><button type="button" class="btn btn-danger">Update Status</button></a>
                                          	  @endif
                                          </td>
										</tr>
                                     @php
