...
<div class="content-header">
	...
	<div class="container mt-4 mb-5">
		...
		@endif
		<form role="form" action="{{ asset('cooperative/edit_loan_action') }}" method="POST" enctype='multipart/form-data'>
			@CSRF
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="loan_date" class="form-control @error('loan_date') is-invalid @enderror" id="loan-date" value="{{ $loaninfo->loan_date }}">
					@error('loan_date')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="loan_balance_as_date" class="form-control @error('loan_balance_as_date') is-invalid @enderror" id="loan_balance_as_date" value="{{ $loaninfo->loan_balance_as_date }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-check  form-check-inline">
                        <input class="form-check-input" type="radio" name="loan_status" id="open" value="Open"
                            @if(!empty($loaninfo->loan_status) && ($loaninfo->loan_status == 'Open')) {{ 'Checked' }} @endif >
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="dob" class="form-control @error('dob') is-invalid @enderror" id="dob" value="{{ $loaninfo->dob }}">
					@error('dob')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="mobile_no" class="form-control @error('mobile_no') is-invalid @enderror" id="mobile_no" placeholder="MOBILE CARD" value="{{ $loaninfo->mobile_no }}" >
					@error('mobile_no')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="dob">Date Of Birth </label>
                    <input type="date" name="coborrower_dob" class="form-control @error('coborrower_dob') is-invalid @enderror" id="coborrower_dob" value="{{ $loaninfo->coborrower_dob }}">
                ...
                <div class="form-group col-md-6">
                    <label for="mobile">Mobile Number</label>
                    <input type="text" name="coborrower_mobile_no" class="form-control @error('coborrower_mobile_no') is-invalid @enderror" id="coborrower_mobile_no" placeholder="MOBILE CARD" value="{{ $loaninfo->coborrower_mobile_no }}" >
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="dob">Date Of Birth </label>
                    <input type="date" name="guarantor1_dob" class="form-control @error('guarantor1_dob') is-invalid @enderror" id="guarantor1_dob" value="{{ $loaninfo->guarantor1_dob }}">
                ...
                <div class="form-group col-md-6">
                    <label for="mobile">Mobile Number</label>
                    <input type="text" name="guarantor1_mobile_no" class="form-control @error('guarantor1_mobile_no') is-invalid @enderror" id="guarantor1_mobile_no" placeholder="MOBILE CARD" value="{{ $loaninfo->guarantor1_mobile_no }}" >
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="dob">Date Of Birth </label>
                    <input type="date" name="guarantor2_dob" class="form-control @error('guarantor2_dob') is-invalid @enderror" id="guarantor2_dob" value="{{ $loaninfo->guarantor2_dob }}">
                ...
                <div class="form-group col-md-6">
                    <label for="mobile">Mobile Number</label>
                    <input type="text" name="guarantor2_mobile_no" class="form-control @error('guarantor2_mobile_no') is-invalid @enderror" id="guarantor2_mobile_no" placeholder="MOBILE CARD" value="{{ $loaninfo->guarantor2_mobile_no }}" >
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="case_filed_on" class="form-control @error('case_filed_on') is-invalid @enderror" id="case_filed_on" placeholder="Case Filed On" value="{{ $loaninfo->case_filed_on }}" >
					@error('case_filed_on')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
                ...
                <div class="form-group col-md-6">
					...
					<input type="date" name="recovery_order_date" class="form-control @error('recovery_order_date') is-invalid @enderror" id="recovery_order_date" placeholder="Recovery Order Date" value="{{ $loaninfo->recovery_order_date }}" >
